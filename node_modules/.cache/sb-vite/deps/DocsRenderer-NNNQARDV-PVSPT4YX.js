...
var Source = ({ isLoading, error, language, code, dark, format: format2, ...rest }) => {
  ...
  return import_react2.default.createElement(ThemeProvider, { theme: convert(overrideTheme) }, syntaxHighlighter);
};
...
var Zoom2 = ({ zoom, resetZoom }) => import_react2.default.createElement(import_react2.default.Fragment, null, import_react2.default.createElement(IconButton, { key: "zoomin", onClick: (e) => {
  e.preventDefault(), zoom(0.8);
}, title: "Zoom in" }, import_react2.default.createElement(Icons, { icon: "zoom" })), import_react2.default.createElement(IconButton, { key: "zoomout", onClick: (e) => {
  e.preventDefault(), zoom(1.25);
}, title: "Zoom out" }, import_react2.default.createElement(Icons, { icon: "zoomout" })), import_react2.default.createElement(IconButton, { key: "zoomreset", onClick: (e) => {
  e.preventDefault(), resetZoom();
}, title: "Reset zoom" }, import_react2.default.createElement(Icons, { icon: "zoomreset" })));
var Bar = newStyled(FlexBar)({ position: "absolute", left: 0, right: 0, top: 0, transition: "transform .2s linear" });
var Toolbar = ({ isLoading, storyId, baseUrl, zoom, resetZoom, ...rest }) => import_react2.default.createElement(Bar, { ...rest }, import_react2.default.createElement(import_react2.Fragment, { key: "left" }, isLoading ? [1, 2, 3].map((key) => import_react2.default.createElement(IconButtonSkeleton, { key })) : import_react2.default.createElement(Zoom2, { zoom, resetZoom })));
...
var Story = (props) => {
  let { inline } = props;
  return import_react2.default.createElement("div", { id: storyBlockIdFromId(props), className: "sb-story sb-unstyled", "data-story-block": "true" }, inline ? import_react2.default.createElement(InlineStory, { ...props }) : import_react2.default.createElement(IFrameStory, { ...props }));
};
var StorySkeleton = () => import_react2.default.createElement(Loader, null);
...
var Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = false, isExpanded = false, additionalActions, className, layout = "padded", ...props }) => {
  let [expanded, setExpanded] = (0, import_react2.useState)(isExpanded), { source, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = (0, import_react2.useState)(1), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = (0, import_react2.useState)(additionalActions ? [...additionalActions] : []), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = import_global.global, copyToClipboard = (0, import_react2.useCallback)(async (text) => {
  ...
  return import_react2.default.createElement(PreviewContainer, { withSource, withToolbar, ...props, className: previewClasses.join(" ") }, withToolbar && import_react2.default.createElement(PositionedToolbar, { isLoading, border: true, zoom: (z) => setScale(scale * z), resetZoom: () => setScale(1), storyId: getStoryId(children), baseUrl: "./iframe.html" }), import_react2.default.createElement(ZoomContext.Provider, { value: { scale } }, import_react2.default.createElement(Relative, { className: "docs-story", onCopyCapture: withSource && onCopyCapture }, import_react2.default.createElement(ChildrenContainer, { isColumn: isColumn || !Array.isArray(children), columns, layout }, import_react2.default.createElement(Zoom.Element, { scale }, Array.isArray(children) ? children.map((child, i) => import_react2.default.createElement("div", { key: i }, child)) : import_react2.default.createElement("div", null, children))), import_react2.default.createElement(ActionBar, { actionItems }))), withSource && expanded && source);
};
var StyledPreview = newStyled(Preview)(() => ({ ".docs-story": { paddingTop: 32, paddingBottom: 40 } }));
var PreviewSkeleton = () => import_react2.default.createElement(StyledPreview, { isLoading: true, withToolbar: true }, import_react2.default.createElement(StorySkeleton, null));
...
var ArgJsDoc = ({ tags }) => {
  ...
  return !hasDisplayableParams && !hasDisplayableReturns && !hasDisplayableDeprecated ? null : import_react2.default.createElement(import_react2.default.Fragment, null, import_react2.default.createElement(Table, null, import_react2.default.createElement("tbody", null, hasDisplayableDeprecated && import_react2.default.createElement("tr", { key: "deprecated" }, import_react2.default.createElement("td", { colSpan: 2 }, import_react2.default.createElement("strong", null, "Deprecated"), ": ", tags.deprecated)), hasDisplayableParams && params.map((x) => import_react2.default.createElement("tr", { key: x.name }, import_react2.default.createElement("td", null, import_react2.default.createElement("code", null, x.name)), import_react2.default.createElement("td", null, x.description))), hasDisplayableReturns && import_react2.default.createElement("tr", { key: "returns" }, import_react2.default.createElement("td", null, import_react2.default.createElement("code", null, "Returns")), import_react2.default.createElement("td", null, tags.returns.description)))));
};
...
var ArgSummary = ({ value: value2, initialExpandedArgs }) => {
  let { summary, detail } = value2, [isOpen, setIsOpen] = (0, import_react2.useState)(false), [isExpanded, setIsExpanded] = (0, import_react2.useState)(initialExpandedArgs || false);
  if (summary == null)
    return null;
  ...
  return import_react2.default.createElement(WithTooltipPure, { closeOnOutsideClick: true, placement: "bottom", visible: isOpen, onVisibleChange: (isVisible) => {
    setIsOpen(isVisible);
  }, tooltip: import_react2.default.createElement(Detail, { width: calculateDetailWidth(detail) }, import_react2.default.createElement(SyntaxHighlighter2, { language: "jsx", format: false }, detail)) }, import_react2.default.createElement(Expandable, { className: "sbdocs-expandable" }, import_react2.default.createElement("span", null, summaryAsString), import_react2.default.createElement(ArrowIcon, { icon: isOpen ? "arrowup" : "arrowdown" })));
};
var ArgValue = ({ value: value2, initialExpandedArgs }) => value2 == null ? import_react2.default.createElement(EmptyArg, null) : import_react2.default.createElement(ArgSummary, { value: value2, initialExpandedArgs });
...
var BooleanControl = ({ name, value: value2, onChange, onBlur, onFocus }) => {
  let onSetFalse = (0, import_react2.useCallback)(() => onChange(false), [onChange]);
  if (value2 === void 0)
    return import_react2.default.createElement(Form.Button, { id: getControlSetterButtonId(name), onClick: onSetFalse }, "Set boolean");
  let controlId = getControlId(name), parsedValue = typeof value2 == "string" ? parse(value2) : value2;
  return import_react2.default.createElement(Label, { htmlFor: controlId, "aria-label": name }, import_react2.default.createElement("input", { id: controlId, type: "checkbox", onChange: (e) => onChange(e.target.checked), checked: parsedValue, role: "switch", name, onBlur, onFocus }), import_react2.default.createElement("span", { "aria-hidden": "true" }, "False"), import_react2.default.createElement("span", { "aria-hidden": "true" }, "True"));
};
...
var DateControl = ({ name, value: value2, onChange, onFocus, onBlur }) => {
  let [valid, setValid] = (0, import_react2.useState)(true), dateRef = (0, import_react2.useRef)(), timeRef = (0, import_react2.useRef)();
  ...
  return import_react2.default.createElement(FlexSpaced, null, import_react2.default.createElement(Form.Input, { type: "date", max: "9999-12-31", ref: dateRef, id: `${controlId}-date`, name: `${controlId}-date`, onChange: onDateChange, onFocus, onBlur }), import_react2.default.createElement(Form.Input, { type: "time", id: `${controlId}-time`, name: `${controlId}-time`, ref: timeRef, onChange: onTimeChange, onFocus, onBlur }), valid ? null : import_react2.default.createElement("div", null, "invalid"));
};
...
var NumberControl = ({ name, value: value2, onChange, min, max, step, onBlur, onFocus }) => {
  let [inputValue, setInputValue] = (0, import_react2.useState)(typeof value2 == "number" ? value2 : ""), [forceVisible, setForceVisible] = (0, import_react2.useState)(false), [parseError, setParseError] = (0, import_react2.useState)(null), handleChange = (0, import_react2.useCallback)((event) => {
  ...
  }, [value2]), !forceVisible && value2 === void 0 ? import_react2.default.createElement(Form.Button, { id: getControlSetterButtonId(name), onClick: onForceVisible }, "Set number") : import_react2.default.createElement(Wrapper2, null, import_react2.default.createElement(Form.Input, { ref: htmlElRef, id: getControlId(name), type: "number", onChange: handleChange, size: "flex", placeholder: "Edit number...", value: inputValue, valid: parseError ? "error" : null, autoFocus: forceVisible, name, min, max, step, onFocus, onBlur }));
};
...
var CheckboxControl = ({ name, options, value: value2, onChange, isInline }) => {
  if (!options)
    return import_client_logger.logger.warn(`Checkbox with no options: ${name}`), import_react2.default.createElement(import_react2.default.Fragment, null, "-");
  let initial = selectedKeys(value2, options), [selected, setSelected] = (0, import_react2.useState)(initial), handleChange = (e) => {
  ...
  return import_react2.default.createElement(Wrapper3, { isInline }, Object.keys(options).map((key, index) => {
    let id = `${controlId}-${index}`;
    return import_react2.default.createElement(Label2, { key: id, htmlFor: id }, import_react2.default.createElement("input", { type: "checkbox", id, name: id, value: key, onChange: handleChange, checked: selected == null ? void 0 : selected.includes(key) }), import_react2.default.createElement(Text2, null, key));
  }));
};
...
var RadioControl = ({ name, options, value: value2, onChange, isInline }) => {
  if (!options)
    return import_client_logger.logger.warn(`Radio with no options: ${name}`), import_react2.default.createElement(import_react2.default.Fragment, null, "-");
  let selection = selectedKey(value2, options), controlId = getControlId(name);
  return import_react2.default.createElement(Wrapper4, { isInline }, Object.keys(options).map((key, index) => {
    let id = `${controlId}-${index}`;
    return import_react2.default.createElement(Label3, { key: id, htmlFor: id }, import_react2.default.createElement("input", { type: "radio", id, name: id, value: key, onChange: (e) => onChange(options[e.currentTarget.value]), checked: key === selection }), import_react2.default.createElement(Text3, null, key));
  }));
};
...
var SingleSelect = ({ name, value: value2, options, onChange }) => {
  ...
  return import_react2.default.createElement(SelectWrapper, null, import_react2.default.createElement(Icons, { icon: "arrowdown" }), import_react2.default.createElement(OptionsSelect, { id: controlId, value: selection, onChange: handleChange }, import_react2.default.createElement("option", { key: "no-selection", disabled: true }, NO_SELECTION), Object.keys(options).map((key) => import_react2.default.createElement("option", { key, value: key }, key))));
};
var MultiSelect = ({ name, value: value2, options, onChange }) => {
  ...
  return import_react2.default.createElement(SelectWrapper, null, import_react2.default.createElement(OptionsSelect, { id: controlId, multiple: true, value: selection, onChange: handleChange }, Object.keys(options).map((key) => import_react2.default.createElement("option", { key, value: key }, key))));
};
var SelectControl = (props) => {
  let { name, options } = props;
  return options ? props.isMulti ? import_react2.default.createElement(MultiSelect, { ...props }) : import_react2.default.createElement(SingleSelect, { ...props }) : (import_client_logger.logger.warn(`Select with no options: ${name}`), import_react2.default.createElement(import_react2.default.Fragment, null, "-"));
};
...
var JsonArray = class extends import_react2.Component {
  ...
  renderNotCollapsed() {
    ...
    return import_react2.default.createElement("span", { className: "rejt-not-collapsed" }, import_react2.default.createElement("span", { className: "rejt-not-collapsed-delimiter", style: delimiter }, startObject), !addFormVisible && addItemButton, import_react2.default.createElement("ul", { className: "rejt-not-collapsed-list", style: ul }, data.map((item, index) => import_react2.default.createElement(JsonNode, { key: index, name: index.toString(), data: item, keyPath, deep: nextDeep, isCollapsed, handleRemove: this.handleRemoveItem(index), handleUpdateValue: this.handleEditValue, onUpdate: this.onChildUpdate, onDeltaUpdate, readOnly, getStyle, addButtonElement, cancelButtonElement, editButtonElement, inputElementGenerator, textareaElementGenerator, minusMenuElement, plusMenuElement, beforeRemoveAction, beforeAddAction, beforeUpdateAction, logger: logger4, onSubmitValueParser }))), !isReadOnly && addFormVisible && import_react2.default.createElement("div", { className: "rejt-add-form", style: addForm }, import_react2.default.createElement(JsonAddValue, { handleAdd: this.handleAddValueAdd, handleCancel: this.handleAddValueCancel, onlyValue, addButtonElement, cancelButtonElement, inputElementGenerator, keyPath, deep, onSubmitValueParser })), import_react2.default.createElement("span", { className: "rejt-not-collapsed-delimiter", style: delimiter }, endObject), !isReadOnly && removeItemButton);
  }
  render() {
    ...
    return import_react2.default.createElement("div", { className: "rejt-array-node" }, import_react2.default.createElement("span", { onClick: this.handleCollapseMode }, import_react2.default.createElement("span", { className: "rejt-name", style: style.name }, name, " :", " ")), value2);
  }
};
...
var JsonFunctionValue = class extends import_react2.Component {
  ...
  render() {
    ...
    if (editEnabled && !resultOnlyResult) {
      let textareaElement = textareaElementGenerator(VALUE, comeFromKeyPath, deep, name, originalValue, dataType), editButtonElementLayout = (0, import_react2.cloneElement)(editButtonElement, { onClick: this.handleEdit }), cancelButtonElementLayout = (0, import_react2.cloneElement)(cancelButtonElement, { onClick: this.handleCancelEdit }), textareaElementLayout = (0, import_react2.cloneElement)(textareaElement, { ref: this.refInput, defaultValue: originalValue });
      result = import_react2.default.createElement("span", { className: "rejt-edit-form", style: style.editForm }, textareaElementLayout, " ", cancelButtonElementLayout, editButtonElementLayout), minusElement = null;
    } else {
      result = import_react2.default.createElement("span", { className: "rejt-value", style: style.value, onClick: resultOnlyResult ? null : this.handleEditMode }, value2);
    ...
    return import_react2.default.createElement("li", { className: "rejt-function-value-node", style: style.li }, import_react2.default.createElement("span", { className: "rejt-name", style: style.name }, name, " :", " "), result, minusElement);
  }
};
...
var JsonNode = class extends import_react2.Component {
  ...
  render() {
    ...
    switch (dataType) {
      case ERROR:
        return import_react2.default.createElement(JsonObject, { data, name, isCollapsed, keyPath, deep, handleRemove, onUpdate, onDeltaUpdate, readOnly: readOnlyTrue, dataType, getStyle, addButtonElement, cancelButtonElement, editButtonElement, inputElementGenerator, textareaElementGenerator, minusMenuElement, plusMenuElement, beforeRemoveAction, beforeAddAction, beforeUpdateAction, logger: logger4, onSubmitValueParser });
      case OBJECT:
        return import_react2.default.createElement(JsonObject, { data, name, isCollapsed, keyPath, deep, handleRemove, onUpdate, onDeltaUpdate, readOnly, dataType, getStyle, addButtonElement, cancelButtonElement, editButtonElement, inputElementGenerator, textareaElementGenerator, minusMenuElement, plusMenuElement, beforeRemoveAction, beforeAddAction, beforeUpdateAction, logger: logger4, onSubmitValueParser });
      case ARRAY:
      ...
      case STRING:
        return import_react2.default.createElement(JsonValue, { name, value: `"${data}"`, originalValue: data, keyPath, deep, handleRemove, handleUpdateValue, readOnly, dataType, getStyle, cancelButtonElement, editButtonElement, inputElementGenerator, minusMenuElement, logger: logger4, onSubmitValueParser });
      case NUMBER:
        return import_react2.default.createElement(JsonValue, { name, value: data, originalValue: data, keyPath, deep, handleRemove, handleUpdateValue, readOnly, dataType, getStyle, cancelButtonElement, editButtonElement, inputElementGenerator, minusMenuElement, logger: logger4, onSubmitValueParser });
      case BOOLEAN:
        return import_react2.default.createElement(JsonValue, { name, value: data ? "true" : "false", originalValue: data, keyPath, deep, handleRemove, handleUpdateValue, readOnly, dataType, getStyle, cancelButtonElement, editButtonElement, inputElementGenerator, minusMenuElement, logger: logger4, onSubmitValueParser });
      case DATE:
        return import_react2.default.createElement(JsonValue, { name, value: data.toISOString(), originalValue: data, keyPath, deep, handleRemove, handleUpdateValue, readOnly: readOnlyTrue, dataType, getStyle, cancelButtonElement, editButtonElement, inputElementGenerator, minusMenuElement, logger: logger4, onSubmitValueParser });
      case NULL:
        return import_react2.default.createElement(JsonValue, { name, value: "null", originalValue: "null", keyPath, deep, handleRemove, handleUpdateValue, readOnly, dataType, getStyle, cancelButtonElement, editButtonElement, inputElementGenerator, minusMenuElement, logger: logger4, onSubmitValueParser });
      case UNDEFINED:
        return import_react2.default.createElement(JsonValue, { name, value: "undefined", originalValue: "undefined", keyPath, deep, handleRemove, handleUpdateValue, readOnly, dataType, getStyle, cancelButtonElement, editButtonElement, inputElementGenerator, minusMenuElement, logger: logger4, onSubmitValueParser });
      case FUNCTION:
        return import_react2.default.createElement(JsonFunctionValue, { name, value: data.toString(), originalValue: data, keyPath, deep, handleRemove, handleUpdateValue, readOnly, dataType, getStyle, cancelButtonElement, editButtonElement, textareaElementGenerator, minusMenuElement, logger: logger4, onSubmitValueParser });
      case SYMBOL:
        return import_react2.default.createElement(JsonValue, { name, value: data.toString(), originalValue: data, keyPath, deep, handleRemove, handleUpdateValue, readOnly: readOnlyTrue, dataType, getStyle, cancelButtonElement, editButtonElement, inputElementGenerator, minusMenuElement, logger: logger4, onSubmitValueParser });
      default:
        return null;
    }
  }
...
var JsonObject = class extends import_react2.Component {
  ...
  renderCollapsed() {
    let { name, keyPath, deep, data } = this.state, { handleRemove, readOnly, dataType, getStyle, minusMenuElement } = this.props, { minus, collapsed } = getStyle(name, data, keyPath, deep, dataType), keyList = Object.getOwnPropertyNames(data), isReadOnly = readOnly(name, data, keyPath, deep, dataType), removeItemButton = (0, import_react2.cloneElement)(minusMenuElement, { onClick: handleRemove, className: "rejt-minus-menu", style: minus });
  ...
  renderNotCollapsed() {
    let { name, data, keyPath, deep, nextDeep, addFormVisible } = this.state, { isCollapsed, handleRemove, onDeltaUpdate, readOnly, getStyle, dataType, addButtonElement, cancelButtonElement, editButtonElement, inputElementGenerator, textareaElementGenerator, minusMenuElement, plusMenuElement, beforeRemoveAction, beforeAddAction, beforeUpdateAction, logger: logger4, onSubmitValueParser } = this.props, { minus, plus, addForm, ul, delimiter } = getStyle(name, data, keyPath, deep, dataType), keyList = Object.getOwnPropertyNames(data), isReadOnly = readOnly(name, data, keyPath, deep, dataType), addItemButton = (0, import_react2.cloneElement)(plusMenuElement, { onClick: this.handleAddMode, className: "rejt-plus-menu", style: plus }), removeItemButton = (0, import_react2.cloneElement)(minusMenuElement, { onClick: handleRemove, className: "rejt-minus-menu", style: minus }), list = keyList.map((key) => import_react2.default.createElement(JsonNode, { key, name: key, data: data[key], keyPath, deep: nextDeep, isCollapsed, handleRemove: this.handleRemoveValue(key), handleUpdateValue: this.handleEditValue, onUpdate: this.onChildUpdate, onDeltaUpdate, readOnly, getStyle, addButtonElement, cancelButtonElement, editButtonElement, inputElementGenerator, textareaElementGenerator, minusMenuElement, plusMenuElement, beforeRemoveAction, beforeAddAction, beforeUpdateAction, logger: logger4, onSubmitValueParser })), startObject = "{", endObject = "}";
    return import_react2.default.createElement("span", { className: "rejt-not-collapsed" }, import_react2.default.createElement("span", { className: "rejt-not-collapsed-delimiter", style: delimiter }, startObject), !isReadOnly && addItemButton, import_react2.default.createElement("ul", { className: "rejt-not-collapsed-list", style: ul }, list), !isReadOnly && addFormVisible && import_react2.default.createElement("div", { className: "rejt-add-form", style: addForm }, import_react2.default.createElement(JsonAddValue, { handleAdd: this.handleAddValueAdd, handleCancel: this.handleAddValueCancel, addButtonElement, cancelButtonElement, inputElementGenerator, keyPath, deep, onSubmitValueParser })), import_react2.default.createElement("span", { className: "rejt-not-collapsed-delimiter", style: delimiter }, endObject), !isReadOnly && removeItemButton);
  }
  render() {
    ...
    return import_react2.default.createElement("div", { className: "rejt-object-node" }, import_react2.default.createElement("span", { onClick: this.handleCollapseMode }, import_react2.default.createElement("span", { className: "rejt-name", style: style.name }, name, " :", " ")), value2);
  }
};
...
var JsonValue = class extends import_react2.Component {
  ...
  render() {
    ...
    return import_react2.default.createElement("li", { className: "rejt-value-node", style: style.li }, import_react2.default.createElement("span", { className: "rejt-name", style: style.name }, name, " : "), isEditing ? import_react2.default.createElement("span", { className: "rejt-edit-form", style: style.editForm }, inputElementLayout, " ", cancelButtonElementLayout, editButtonElementLayout) : import_react2.default.createElement("span", { className: "rejt-value", style: style.value, onClick: isReadOnly ? null : this.handleEditMode }, String(value2)), !isReadOnly && !isEditing && minusMenuLayout);
  }
};
...
} }, onSubmitValueParser: (isEditMode, keyPath, deep, name, rawValue) => parse3(rawValue), inputElement: () => import_react2.default.createElement("input", null), textareaElement: () => import_react2.default.createElement("textarea", null), fallback: null };
...
var ObjectControl = ({ name, value: value2, onChange }) => {
  let theme = useTheme(), data = (0, import_react2.useMemo)(() => value2 && (0, import_cloneDeep.default)(value2), [value2]), hasData = data != null, [showRaw, setShowRaw] = (0, import_react2.useState)(!hasData), [parseError, setParseError] = (0, import_react2.useState)(null), updateRaw = (0, import_react2.useCallback)((raw) => {
    try {
  ...
  if ((0, import_react2.useEffect)(() => {
    ...
    return import_react2.default.createElement(Form.Button, { id: getControlSetterButtonId(name), onClick: onForceVisible }, "Set object");
  let rawJSONForm = import_react2.default.createElement(RawInput, { ref: htmlElRef, id: getControlId(name), name, defaultValue: value2 === null ? "" : JSON.stringify(value2, null, 2), onBlur: (event) => updateRaw(event.target.value), placeholder: "Edit JSON string...", autoFocus: forceVisible, valid: parseError ? "error" : null });
  return import_react2.default.createElement(Wrapper5, null, ["Object", "Array"].includes(getObjectType(data)) && import_react2.default.createElement(RawButton, { href: "#", onClick: (e) => {
    e.preventDefault(), setShowRaw((v) => !v);
  } }, import_react2.default.createElement(Icons, { icon: showRaw ? "eyeclose" : "eye" }), import_react2.default.createElement("span", null, "RAW")), showRaw ? rawJSONForm : import_react2.default.createElement(JsonTree, { data, rootName: name, onFullyUpdate: onChange, getStyle: getCustomStyleFunction(theme), cancelButtonElement: import_react2.default.createElement(Button, { type: "button" }, "Cancel"), editButtonElement: import_react2.default.createElement(Button, { type: "submit" }, "Save"), addButtonElement: import_react2.default.createElement(Button, { type: "submit", primary: true }, "Save"), plusMenuElement: import_react2.default.createElement(ActionIcon, { icon: "add" }), minusMenuElement: import_react2.default.createElement(ActionIcon, { icon: "subtract" }), inputElement: (_, __, ___, key) => key ? import_react2.default.createElement(Input, { onFocus: selectValue, onBlur: dispatchEnterKey }) : import_react2.default.createElement(Input, null), fallback: rawJSONForm }));
};
...
var RangeControl = ({ name, value: value2, onChange, min = 0, max = 100, step = 1, onBlur, onFocus }) => {
  ...
  }, hasValue = value2 !== void 0, numberOFDecimalsPlaces = (0, import_react2.useMemo)(() => getNumberOfDecimalPlaces(step), [step]);
  return import_react2.default.createElement(RangeWrapper, null, import_react2.default.createElement(RangeLabel, null, min), import_react2.default.createElement(RangeInput, { id: getControlId(name), type: "range", onChange: handleChange, name, value: value2, min, max, step, onFocus, onBlur }), import_react2.default.createElement(RangeCurrentAndMaxLabel, { numberOFDecimalsPlaces, max }, hasValue ? value2.toFixed(numberOFDecimalsPlaces) : "--", " / ", max));
};
...
var TextControl = ({ name, value: value2, onChange, onFocus, onBlur, maxLength }) => {
  ...
  }, [forceVisible, setForceVisible] = (0, import_react2.useState)(false), onForceVisible = (0, import_react2.useCallback)(() => {
    onChange(""), setForceVisible(true);
  }, [setForceVisible]);
  if (value2 === void 0)
    return import_react2.default.createElement(Form.Button, { id: getControlSetterButtonId(name), onClick: onForceVisible }, "Set string");
  let isValid = typeof value2 == "string";
  return import_react2.default.createElement(Wrapper6, null, import_react2.default.createElement(Form.Textarea, { id: getControlId(name), maxLength, onChange: handleChange, size: "flex", placeholder: "Edit string...", autoFocus: forceVisible, valid: isValid ? null : "error", name, value: isValid ? value2 : "", onFocus, onBlur }), maxLength && import_react2.default.createElement(MaxLength, { isMaxed: (value2 == null ? void 0 : value2.length) === maxLength }, (value2 == null ? void 0 : value2.length) ?? 0, " / ", maxLength));
};
...
var FilesControl = ({ onChange, name, accept = "image/*", value: value2 }) => {
  let inputElement = (0, import_react2.useRef)(null);
  ...
  }, [value2, name]), import_react2.default.createElement(FileInput, { ref: inputElement, id: getControlId(name), type: "file", name, multiple: true, onChange: handleFileChange, accept, size: "flex" });
};
var LazyColorControl = (0, import_react2.lazy)(() => import("./Color-6VNJS4EI-56TE55CQ.js"));
...
var ArgControl = ({ row, arg, updateArgs, isHovered }) => {
  let { key, control } = row, [isFocused, setFocused] = (0, import_react2.useState)(false), [boxedValue, setBoxedValue] = (0, import_react2.useState)({ value: arg });
  (0, import_react2.useEffect)(() => {
    isFocused || setBoxedValue({ value: arg });
  }, [isFocused, arg]);
  let onChange = (0, import_react2.useCallback)((argVal) => (setBoxedValue({ value: argVal }), updateArgs({ [key]: argVal }), argVal), [updateArgs, key]), onBlur = (0, import_react2.useCallback)(() => setFocused(false), []), onFocus = (0, import_react2.useCallback)(() => setFocused(true), []);
  if (!control || control.disable)
    return isHovered ? import_react2.default.createElement(Link2, { href: "https://storybook.js.org/docs/react/essentials/controls", target: "_blank", withArrow: true }, "Setup controls") : import_react2.default.createElement(NoControl, null);
...
var ArgRow = (props) => {
  var _a;
  let [isHovered, setIsHovered] = (0, import_react2.useState)(false), { row, updateArgs, compact, expandable, initialExpandedArgs } = props, { name, description } = row, table = row.table || {}, type = table.type || row.type, defaultValue = table.defaultValue || row.defaultValue, required = (_a = row.type) == null ? void 0 : _a.required, hasDescription = description != null && description !== "";
  return import_react2.default.createElement("tr", { onMouseEnter: () => setIsHovered(true), onMouseLeave: () => setIsHovered(false) }, import_react2.default.createElement(StyledTd, { expandable }, import_react2.default.createElement(Name, null, name), required ? import_react2.default.createElement(Required, { title: "Required" }, "*") : null), compact ? null : import_react2.default.createElement("td", null, hasDescription && import_react2.default.createElement(Description, null, import_react2.default.createElement(index_modern_default, null, description)), table.jsDocTags != null ? import_react2.default.createElement(import_react2.default.Fragment, null, import_react2.default.createElement(TypeWithJsDoc, { hasDescription }, import_react2.default.createElement(ArgValue, { value: type, initialExpandedArgs })), import_react2.default.createElement(ArgJsDoc, { tags: table.jsDocTags })) : import_react2.default.createElement(Type, { hasDescription }, import_react2.default.createElement(ArgValue, { value: type, initialExpandedArgs }))), compact ? null : import_react2.default.createElement("td", null, import_react2.default.createElement(ArgValue, { value: defaultValue, initialExpandedArgs })), updateArgs ? import_react2.default.createElement("td", null, import_react2.default.createElement(ArgControl, { ...props, isHovered })) : null);
};
...
var SectionRow = ({ level = "section", label, children, initialExpanded = true, colSpan = 3 }) => {
  let [expanded, setExpanded] = (0, import_react2.useState)(initialExpanded), Level = level === "subsection" ? Subsection : Section, itemCount = (children == null ? void 0 : children.length) || 0, caption = level === "subsection" ? `${itemCount} item${itemCount !== 1 ? "s" : ""}` : "", icon = expanded ? "arrowdown" : "arrowright", helperText = `${expanded ? "Hide" : "Show"} ${level === "subsection" ? itemCount : label} item${itemCount !== 1 ? "s" : ""}`;
  return import_react2.default.createElement(import_react2.default.Fragment, null, import_react2.default.createElement(StyledTr, { title: helperText }, import_react2.default.createElement(Level, { colSpan: 1 }, import_react2.default.createElement(ClickIntercept, { onClick: (e) => setExpanded(!expanded), tabIndex: 0 }, helperText), import_react2.default.createElement(FlexWrapper, null, import_react2.default.createElement(ExpanderIcon, { icon }), label)), import_react2.default.createElement(StyledTd2, { colSpan: colSpan - 1 }, import_react2.default.createElement(ClickIntercept, { onClick: (e) => setExpanded(!expanded), tabIndex: -1, style: { outline: "none" } }, helperText), expanded ? null : caption)), expanded ? children : null);
};
...
var Empty = ({ inAddonPanel }) => {
  ...
  }, []), isLoading ? null : import_react2.default.createElement(Wrapper7, { inAddonPanel }, import_react2.default.createElement(Content, null, import_react2.default.createElement(Title2, null, inAddonPanel ? "Interactive story playground" : "Args table with interactive controls couldn't be auto-generated"), import_react2.default.createElement(Description2, null, "Controls give you an easy to use interface to test your components. Set your story args and you'll see controls appearing here automatically.")), import_react2.default.createElement(Links, null, inAddonPanel && import_react2.default.createElement(import_react2.default.Fragment, null, import_react2.default.createElement(Link2, { href: "https://youtu.be/0gOfS6K0x0E", target: "_blank", withArrow: true }, import_react2.default.createElement(Icons, { icon: "video" }), " Watch 5m video"), import_react2.default.createElement(Divider, null), import_react2.default.createElement(Link2, { href: "https://storybook.js.org/docs/react/essentials/controls", target: "_blank", withArrow: true }, "Read docs")), !inAddonPanel && import_react2.default.createElement(Link2, { href: "https://storybook.js.org/docs/react/essentials/controls", target: "_blank", withArrow: true }, "Learn how to set that up")));
};
...
var ArgsTable = (props) => {
  ...
  if ("error" in props) {
    let { error } = props;
    return import_react2.default.createElement(EmptyBlock, null, error, " ", import_react2.default.createElement(Link2, { href: "http://storybook.js.org/docs/", target: "_blank", withArrow: true }, "Read the docs"));
  }
  if (isLoading)
  ...
  return import_react2.default.createElement(ResetWrapper, null, import_react2.default.createElement(TableWrapper, { compact, inAddonPanel, className: "docblock-argstable sb-unstyled" }, import_react2.default.createElement("thead", { className: "docblock-argstable-head" }, import_react2.default.createElement("tr", null, import_react2.default.createElement("th", null, import_react2.default.createElement("span", null, "Name")), compact ? null : import_react2.default.createElement("th", null, import_react2.default.createElement("span", null, "Description")), compact ? null : import_react2.default.createElement("th", null, import_react2.default.createElement("span", null, "Default")), updateArgs ? import_react2.default.createElement("th", null, import_react2.default.createElement(ControlHeadingWrapper, null, "Control", " ", !isLoading && resetArgs && import_react2.default.createElement(StyledIconButton, { onClick: () => resetArgs(), title: "Reset controls" }, import_react2.default.createElement(Icons, { icon: "undo", "aria-hidden": true })))) : null)), import_react2.default.createElement("tbody", { className: "docblock-argstable-body" }, groups.ungrouped.map((row) => import_react2.default.createElement(ArgRow, { key: row.key, row, arg: args && args[row.key], ...common })), Object.entries(groups.ungroupedSubsections).map(([subcategory, subsection]) => import_react2.default.createElement(SectionRow, { key: subcategory, label: subcategory, level: "subsection", colSpan }, subsection.map((row) => import_react2.default.createElement(ArgRow, { key: row.key, row, arg: args && args[row.key], expandable, ...common })))), Object.entries(groups.sections).map(([category, section]) => import_react2.default.createElement(SectionRow, { key: category, label: category, level: "section", colSpan }, section.ungrouped.map((row) => import_react2.default.createElement(ArgRow, { key: row.key, row, arg: args && args[row.key], ...common })), Object.entries(section.subsections).map(([subcategory, subsection]) => import_react2.default.createElement(SectionRow, { key: subcategory, label: subcategory, level: "subsection", colSpan }, subsection.map((row) => import_react2.default.createElement(ArgRow, { key: row.key, row, arg: args && args[row.key], expandable, ...common })))))))));
};
var TabbedArgsTable = ({ tabs, ...props }) => {
  let entries = Object.entries(tabs);
  return entries.length === 1 ? import_react2.default.createElement(ArgsTable, { ...entries[0][1], ...props }) : import_react2.default.createElement(TabsState, null, entries.map((entry) => {
    let [label, table] = entry, id = `prop_table_div_${label}`;
    return import_react2.default.createElement("div", { key: id, id, title: label }, ({ active }) => active ? import_react2.default.createElement(ArgsTable, { key: `prop_table_${label}`, ...table, ...props }) : null);
  }));
};
...
var useArgs = (storyId, context) => {
  let storyContext = context.getStoryContext(context.storyById()), [args, setArgs] = (0, import_react2.useState)(storyContext.args);
  (0, import_react2.useEffect)(() => {
    let cb = (changed) => {
  ...
  let updateArgs = (0, import_react2.useCallback)((updatedArgs) => context.channel.emit(import_core_events.UPDATE_STORY_ARGS, { storyId, updatedArgs }), [storyId]), resetArgs = (0, import_react2.useCallback)((argNames) => context.channel.emit(import_core_events.RESET_STORY_ARGS, { storyId, argNames }), [storyId]);
  return [args, updateArgs, resetArgs];
};
var useGlobals = (context) => {
  let storyContext = context.getStoryContext(context.storyById()), [globals, setGlobals] = (0, import_react2.useState)(storyContext.globals);
  return (0, import_react2.useEffect)(() => {
    let cb = (changed) => {
...
var StoryTable = (props) => {
  let context = (0, import_react2.useContext)(DocsContext), { story: storyName, component, subcomponents, showComponent, include, exclude, sort } = props;
  try {
    let storyId;
    switch (storyName) {
      case PRIMARY_STORY: {
    ...
    if (!story)
      return import_react2.default.createElement(ArgsTable, { isLoading: true, updateArgs, resetArgs });
    ...
    return import_react2.default.createElement(TabbedArgsTable, { tabs, sort });
  } catch (err) {
    return import_react2.default.createElement(ArgsTable, { error: err.message });
  }
};
...
var ArgsTable2 = (props) => {
  ...
  `);
  let context = (0, import_react2.useContext)(DocsContext), parameters, component, subcomponents;
  try {
  ...
  if (storyName)
    return import_react2.default.createElement(StoryTable, { ...props, component: main, subcomponents, sort });
  if (!components22 && !subcomponents) {
    ...
    return import_react2.default.createElement(ArgsTable, { ...mainProps, sort });
  }
  if (components22)
    return import_react2.default.createElement(ComponentsTable, { ...props, components: components22, sort, parameters });
  let mainLabel = getComponentName(main);
  return import_react2.default.createElement(ComponentsTable, { ...props, components: { [mainLabel]: main, ...subcomponents }, sort, parameters });
};
...
var Canvas = (props) => {
  ...
  let docsContext = (0, import_react2.useContext)(DocsContext), sourceContext = (0, import_react2.useContext)(SourceContext), { children, of, source } = props;
  if ("of" in props && of === void 0)
    throw new Error("Unexpected `of={undefined}`, did you mistype a CSF file reference?");
  ...
  if (props.withSource && (0, import_client_logger.deprecate)(esm_default`Setting source state with \`withSource\` is deprecated, please use \`sourceState\` with 'hidden', 'shown' or 'none' instead. 
    ...
    Please refer to the migration guide: https://github.com/storybookjs/storybook/blob/next/MIGRATION.md#canvas-block
  `), isLoading ? import_react2.default.createElement(PreviewSkeleton, null) : import_react2.default.createElement(Preview, { ...previewProps }, children);
...
var useArgsIfDefined = (story, context) => {
  let storyContext = story ? context.getStoryContext(story) : { args: {} }, { id: storyId } = story || { id: "none" }, [args, setArgs] = (0, import_react2.useState)(storyContext.args);
  (0, import_react2.useEffect)(() => {
...
var Controls3 = (props) => {
  ...
  return import_react2.default.createElement(ArgsTable, { rows: filteredArgTypes, args, globals, updateArgs, resetArgs, sort });
};
var { document: document2 } = import_global.global;
var CodeOrSourceMdx = ({ className, children, ...rest }) => {
  if (typeof className != "string" && (typeof children != "string" || !children.match(/[\n\r]/g)))
    return import_react2.default.createElement(Code, null, children);
  let language = className && className.split("-");
  return import_react2.default.createElement(Source, { language: language && language[1] || "plaintext", format: false, code: children, ...rest });
};
...
var AnchorInPage = ({ hash, children }) => {
  ...
  return import_react2.default.createElement(A, { href: hash, target: "_self", onClick: (event) => {
...
var AnchorMdx = (props) => {
  ...
  if (href) {
    if (href.startsWith("#"))
      return import_react2.default.createElement(AnchorInPage, { hash: href }, children);
    if (target !== "_blank" && !href.startsWith("https://"))
      return import_react2.default.createElement(A, { href, onClick: (event) => {
...
var HeaderWithOcticonAnchor = ({ as, id, children, ...rest }) => {
  ...
  return import_react2.default.createElement(OcticonHeader, { id, ...rest }, import_react2.default.createElement(OcticonAnchor, { "aria-hidden": "true", href: hash, tabIndex: -1, target: "_self", onClick: (event) => {
    document2.getElementById(id) && navigate(context, hash);
  } }, import_react2.default.createElement(Icons, { icon: "link" })), children);
};
var HeaderMdx = (props) => {
  ...
  return import_react2.default.createElement(Component4, { ...nameSpaceClassNames(withoutAs, as) });
};
...
var DescriptionContainer = (props) => {
  ...
  if ("of" in props && of === void 0)
    throw new Error("Unexpected `of={undefined}`, did you mistype a CSF file reference?");
  let context = (0, import_react2.useContext)(DocsContext), resolvedOf = useOf(of || "meta"), markdown;
  return type || markdownProp || children ? markdown = getDescriptionFromDeprecatedProps(props, context) : markdown = getDescriptionFromResolvedOf(resolvedOf), type && (0, import_client_logger.deprecate)(`Manually specifying description type is deprecated. See ${DEPRECATION_MIGRATION_LINK}`), markdownProp && (0, import_client_logger.deprecate)(`The 'markdown' prop on the Description block is deprecated. See ${DEPRECATION_MIGRATION_LINK}`), children && (0, import_client_logger.deprecate)(`The 'children' prop on the Description block is deprecated. See ${DEPRECATION_MIGRATION_LINK}`), markdown ? import_react2.default.createElement(Markdown2, null, markdown) : null;
};
...
}, [disable]), import_react2.default.createElement(import_react2.default.Fragment, null, import_react2.default.createElement(Wrapper9, null, disable ? null : import_react2.default.createElement(Content2, null, import_react2.default.createElement(OptionalTitle, { title: title || null }), import_react2.default.createElement("div", { className: "toc-wrapper" })))));
...
var DocsContainer = ({ context, theme, children }) => {
  ...
  }), import_react2.default.createElement(DocsContext.Provider, { value: context }, import_react2.default.createElement(SourceContainer, { channel: context.channel }, import_react2.default.createElement(ThemeProvider, { theme: ensure(theme) }, import_react2.default.createElement(DocsPageWrapper, { toc: toc ? import_react2.default.createElement(TableOfContents, { className: "sbdocs sbdocs-toc--custom", ...toc }) : null }, children))));
};
...
var Title3 = ({ children }) => {
  let context = (0, import_react2.useContext)(DocsContext), content = children || extractTitle(context.storyById().title);
...
var Subtitle2 = ({ children }) => {
  var _a;
  let docsContext = (0, import_react2.useContext)(DocsContext), content = children || ((_a = docsContext.storyById().parameters) == null ? void 0 : _a.componentSubtitle);
...
var Subheading = ({ children, disableAnchor }) => {
  if (disableAnchor || typeof children != "string")
    return import_react2.default.createElement(H3, null, children);
...
var Primary = (props) => {
  ...
  if ("of" in props && of === void 0)
    throw new Error("Unexpected `of={undefined}`, did you mistype a CSF file reference?");
  let docsContext = (0, import_react2.useContext)(DocsContext), story;
  ...
  return name && (0, import_client_logger.deprecate)(esm_default`\`name\` prop is deprecated on the Primary block.
    ...
    `), story ? import_react2.default.createElement(DocsStory, { of: story.moduleExport, expanded: false, __primary: true, withToolbar: true }) : null;
};
var Heading2 = ({ children, disableAnchor, ...props }) => {
  if (disableAnchor || typeof children != "string")
    return import_react2.default.createElement(H2, null, children);
  let tagID = children.toLowerCase().replace(/[^a-z0-9]/gi, "-");
...
var DocsRenderer = class {
  constructor() {
    this.render = async (context, docsParameter, element) => {
      ...
      return new Promise((resolve, reject) => {
        import("./react-ZJG4YSPW.js").then(({ MDXProvider }) => renderElement(import_react3.default.createElement(ErrorBoundary, { showException: reject, key: Math.random() }, import_react3.default.createElement(MDXProvider, { components }, import_react3.default.createElement(TDocs, { context, docsParameter }))), element)).then(() => resolve());
      });
...
//# sourceMappingURL=DocsRenderer-NNNQARDV-PVSPT4YX.js.map
